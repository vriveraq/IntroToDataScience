# GOAL: Understand sampling and linear regression concepts
# DATA: Cats data set (Part 2) and  prestige data set from cars library (Part 3).
...
## 1.  What is the interpretation of the coefficient B1? (What meaning does it represent?)
...
## 3.  How could you deal with outliers in order to improve the accuracy of your model?
...
## 4. Subset the data frame to ONLY include female cats.
...
## This problem will use the Prestige dataset. Load the data by running code below
...
## 12. 
## Discuss what your regression results mean in the context of the data. (Hint: Think back to Question 1)
